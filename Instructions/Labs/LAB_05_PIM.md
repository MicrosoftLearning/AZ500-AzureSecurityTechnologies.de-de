...
Sie wurden aufgefordert, einen Proof of Concept zu erstellen, der Microsoft Entra Privileged Identity Management (PIM) verwendet, um Just-in-Time-Verwaltung zu ermöglichen und die Anzahl der Benutzer zu steuern, die privilegierte Vorgänge ausführen können. Dies sind die spezifischen Anforderungen:

- Erstellen einer permanenten Zuweisung des Microsoft Entra ID-Benutzers aaduser2 zur Rolle „Sicherheitsadministrator“. 
- Konfigurieren des Microsoft Entra ID-Benutzers aaduser2 für die Rollen „Abrechnungsadministrator“ und „Globaler Leser“.
- Konfigurieren der Aktivierung der Global Reader-Rolle so, dass eine Genehmigung des Microsoft Entra ID-Benutzers „aaduser3“ erforderlich ist.
...
> Bevor Sie fortfahren, stellen Sie sicher, dass Sie Lab 04 abgeschlossen haben: MFA, bedingter Zugriff und Microsoft Entra Identität Protection Sie benötigen sowohl den Microsoft Entra-Mandanten (AdatumLab500-04) als auch die Benutzerkonten aaduser1, aaduser2 und aaduser3.
...
## Microsoft Entra Privileged Identity Management Diagramm
...
In dieser Aufgabe weisen Sie einem Benutzer die Berechtigung für eine Microsoft Entra ID-Rolle zu.

1. Melden Sie sich unter **`https://portal.azure.com/`** beim Azure-Portal an.

    >**Hinweis**: Stellen Sie sicher, dass Sie beim Microsoft Entra-Mandanten **AdatumLab500-04** angemeldet sind. Sie können den Filter **Verzeichnis und Abonnement** verwenden, um zwischen Microsoft Entra-Mandanten zu wechseln. Stellen Sie sicher, dass Sie als Benutzer mit der Rolle „Globaler Administrator“ angemeldet sind.
...
2. Geben Sie im Azure-Portal oben auf der Azure-Portalseite im Textfeld **Nach Ressourcen, Diensten und Dokumenten suchen** den Begriff **Microsoft Entra Privileged Identity Management** ein, und drücken Sie die **Eingabetaste**.

3. Klicken Sie auf dem Blatt **Privileged Identity Management** im Abschnitt **Verwalten** auf **Microsoft Entra ID-Rollen**.
...
1. Navigieren Sie im Azure-Portal zurück zum Blatt **Privileged Identity Management**, und klicken Sie auf **Microsoft Entra ID-Rollen**.
...
2. Navigieren Sie im InPrivate-Browserfenster zum Azure-Portal unter **`https://portal.azure.com/`** und melden Sie sich mit dem Benutzerkonto **aaduser2** an.
    ...
    >**Hinweis**: Für die Anmeldung müssen Sie einen vollqualifizierten Namen des Benutzerkontos **aaduser2** angeben, einschließlich des DNS-Domänennamens des Microsoft Entra-Mandanten, den Sie sich zuvor in diesem Lab erfasst haben. Dieser Benutzername weist das Format aaduser2@`<your_tenant_name>`.onmicrosoft.com auf, wobei `<your_tenant_name>` der Platzhalter ist, der Ihren eindeutigen Microsoft Entra-Mandantennamen darstellt. 

3. Geben Sie im Azure-Portal oben auf der Azure-Portalseite im Textfeld **Nach Ressourcen, Diensten und Dokumenten suchen** den Begriff **Microsoft Entra Privileged Identity Management** ein, und drücken Sie die **Eingabetaste**.
...
10. Wechseln Sie auf dem Blatt **Meine Rollen \| Microsoft Entra ID-Rollen** zur Registerkarte **Aktive Zuweisungen**. Beachten Sie, dass die Rolle **Abrechnungsadministrator****aktiviert** ist.
...
3. Klicken Sie auf dem Blatt **Meine Rollen \| Microsoft Entra ID-Rollen** in der Liste **Berechtigte Zuweisungen**in der Zeile mit der Rolle **Globaler Leser** auf **Aktivieren**. 
...
6. Suchen Sie auf dem Blatt **Meine Rollen \| Microsoft Entra ID-Rollen** die Rolle **Sicherheitsadministrator**, und klicken Sie auf **Aktivieren**. 
...
9. Klicken Sie auf dem Blatt **Meine Rollen \| Microsoft Entra ID-Rollen** auf die Registerkarte **Aktive Zuweisungen**, und beachten Sie, dass die Liste **Aktive Zuweisungen** die Rolle **Sicherheitsadministrator**, aber nicht die Rolle **Globaler Leser** enthält.
...
11. Melden Sie sich im InPrivate-Browser am Azure-Portal unter **`https://portal.azure.com/`** als **aaduser3** an.
    ...
    >**Hinweis**: Wenn bei der Authentifizierung mit einem der Benutzerkonten Probleme auftreten, können Sie sich beim Microsoft Entra-Mandanten anmelden, indem Sie Ihr Benutzerkonto verwenden, um seine Kennwörter zurückzusetzen oder seine Anmeldeoptionen neu zu konfigurieren.

12. Navigieren Sie im Azure-Portal zu **Microsoft Entra Privileged Identity Management** (Geben Sie im Textfeld „Ressourcen, Dienste und Dokumente durchsuchen“ oben auf der Azure-Portal-Seite „Microsoft Entra Privileged Identity Management“ ein, und drücken Sie die Eingabetaste).
...
14. Aktivieren Sie auf dem Blatt **Anforderungen genehmigen \| Microsoft Entra ID-Rollen** im Abschnitt **Anforderungen für Rollenaktivierungen** das Kontrollkästchen für den Eintrag, der die Rollenaktivierungsanforderung für die Rolle **Globaler Leser** von **aaduser2** darstellt.
...
18. Navigieren Sie im Azure-Portal zu **Microsoft Entra Privileged Identity Management** (Geben Sie im Textfeld „Ressourcen, Dienste und Dokumente durchsuchen“ oben auf der Azure-Portal-Seite „Microsoft Entra Privileged Identity Management“ ein, und drücken Sie die Eingabetaste).

19. Klicken Sie auf dem Blatt **Privileged Identity Management \| Schnellstart** im Abschnitt **Aufgaben** auf **Meine Rollen**.

20. Klicken Sie auf dem Blatt **Meine Rollen \| Microsoft Entra ID-Rollen** auf die Registerkarte **Aktive Zuweisungen**, und überprüfen Sie, ob die Rolle „Globaler Leser“ jetzt aktiv ist.
...
- Aufgabe 1: Konfigurieren von Sicherheitswarnungen für Microsoft Entra ID-Rollen in PIM
...
4. Klicken Sie auf dem Blatt **Privileged Identity Management \| Schnellstart** im Abschnitt **Verwalten** auf **Microsoft Entra-Rollen**.
...
17. Navigieren Sie zurück zum Blatt **Privileged Identity Management**, und klicken Sie im Abschnitt **Verwalten** auf **Microsoft Entra-Rollen**.
...
1. Navigieren Sie zurück zum Blatt **Privileged Identity Management**, und klicken Sie im Abschnitt **Verwalten** auf **Microsoft Entra-Rollen**.
...
1. Legen Sie im Azure-Portal den Filter **Verzeichnis und Abonnement** auf den Microsoft Entra-Mandanten fest, der dem Azure-Abonnement zugeordnet ist, in dem Sie die Azure-VM **az500-04-vm1** bereitgestellt haben.

    >**Hinweis**: Wenn der Haupteintrag Ihres Microsoft Entra-Mandanten nicht angezeigt wird, klicken Sie auf den Link „Verzeichnis wechseln“, wählen Sie Ihre Hauptmandantenzeile aus, und klicken Sie auf die Schaltfläche „Wechseln“.
...
6. Verwenden Sie im Azure-Portal den Filter **Verzeichnis und Abonnement**, um zum Microsoft Entra-Mandanten **AdatumLab500-04** zu wechseln.

7. Navigieren Sie zum Microsoft Entra-Blatt **AdatumLab500-04**, und klicken Sie im Abschnitt **Verwalten** auf **Lizenzen**.

8. Klicken Sie auf dem Blatt **Lizenzen** | Übersicht auf **Alle Produkte**, aktivieren Sie das Kontrollkästchen von **Microsoft Entra ID P2** und klicken Sie darauf, um es zu öffnen.

    >**Hinweis**: In Lab 4, Übung 2, Aufgabe 4 **Zuweisen von Microsoft Entra ID P2-Lizenzen an Microsoft Entra-Benutzer** sollten Sie die Premium-Lizenzen an die Benutzer **aaduser1, aaduser2 und aaduser3** vergeben. Stellen Sie sicher, dass Sie diese Lizenzen von den zugewiesenen Benutzern entfernen.

9. Aktivieren Sie auf dem Blatt **Microsoft Entra ID P2 – Lizenzierte Benutzer** die Kontrollkästchen der Benutzerkonten, denen Sie **Microsoft Entra ID P2**-Lizenzen zugewiesen haben. Klicken Sie im oberen Bereich auf **Lizenz entfernen**, und wählen Sie **Ja** aus, wenn Sie zur Bestätigung aufgefordert werden.
...
12. Navigieren Sie zum Blatt **AdatumLab500-04 – Übersicht** des Microsoft Entra-Mandanten, wählen Sie **Mandanten verwalten** aus, und aktivieren Sie dann auf dem nächsten Bildschirm das Kontrollkästchen neben **AdatumLab500-04**, und wählen Sie **Löschen** aus. Wählen Sie auf dem Blatt **Mandant „AdatumLab500-04“ löschen** den Link **Berechtigung zum Löschen von Azure-Ressourcen anfordern** aus. Legen Sie auf dem Azure Microsoft Entra ID-Blatt **Eigenschaften** die Option **Zugriffsverwaltung für Azure-Ressourcen** auf **Ja** fest, und wählen Sie **Speichern** aus.
