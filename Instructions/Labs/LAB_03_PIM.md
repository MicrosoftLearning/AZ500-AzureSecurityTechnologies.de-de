...
- Konfigurieren, dass die Aktivierung der Rolle „Globaler Leser“ eine Genehmigung des Microsoft Entra ID-Benutzers aaduser3 erfordert
...
> Bevor Sie fortfahren, stellen Sie sicher, dass Sie Lab 02: „MFA, bedingter Zugriff und Microsoft Entra Identität Protection“ abgeschlossen haben. Sie benötigen sowohl den Microsoft Entra-Mandanten (AdatumLab500-04) als auch die Benutzerkonten aaduser1, aaduser2 und aaduser3.
...
1. Melden Sie sich unter **`https://portal.azure.com/`** beim Azure-Portal an.
    ...
    >**Hinweis**: Stellen Sie sicher, dass Sie beim Microsoft Entra-Mandanten **AdatumLab500-04** angemeldet sind. Sie können den Filter **Verzeichnis + Abonnement** verwenden, um zwischen Microsoft Entra-Mandanten zu wechseln. Stellen Sie sicher, dass Sie als Benutzer mit der Rolle „Globaler Administrator“ angemeldet sind.
...
2. Geben Sie im Azure-Portal oben auf der Azure-Portalseite im Textfeld **Ressourcen, Dienste und Dokumente durchsuchen** den Begriff **Microsoft Entra Privileged Identity Management** ein, und drücken Sie die **Eingabetaste**.
...
2. Navigieren Sie im InPrivate-Browserfenster zum Azure-Portal unter **`https://portal.azure.com/`** und melden Sie sich mit dem Benutzerkonto **aaduser2** an.
    ...
    >**Hinweis**: Für die Anmeldung müssen Sie einen vollqualifizierten Namen des Benutzerkontos **aaduser2** angeben, einschließlich des DNS-Domänennamens des Microsoft Entra ID-Mandanten, den Sie sich zuvor in diesem Lab notiert haben. Dieser Benutzername weist das Format „syncadmin@`<your_tenant_name>`.onmicrosoft.com“ auf, wobei `<your_tenant_name>` der Platzhalter für Ihren eindeutigen Microsoft Entra-Mandantennamen ist. 

3. Geben Sie im Azure-Portal oben auf der Azure-Portalseite im Textfeld **Ressourcen, Dienste und Dokumente durchsuchen** den Begriff **Microsoft Entra Privileged Identity Management** ein, und drücken Sie die **Eingabetaste**.
...
17. Navigieren Sie zurück zum Blatt **Privileged Identity Management**, und klicken Sie im Abschnitt **Verwalten** auf **Microsoft Entra ID-Rollen**.
...
1. Navigieren Sie zurück zum Blatt **Privileged Identity Management**, und klicken Sie im Abschnitt **Verwalten** auf **Microsoft Entra ID-Rollen**.
...
1. Legen Sie im Azure-Portal den Filter **Verzeichnis + Abonnement** auf den Microsoft Entra-Mandanten fest, der dem Azure-Abonnement zugeordnet ist, in dem Sie die Azure-VM **az500-04-vm1** bereitgestellt haben.
...
6. Verwenden Sie im Azure-Portal den Filter **Verzeichnis + Abonnement**, um zum Microsoft Entra-Mandanten **AdatumLab500-04** zu wechseln.

7. Navigieren Sie zum Microsoft Entra-Blatt **AdatumLab500-04**, und klicken Sie im Abschnitt **Verwalten** auf **Lizenzen**.

8. Klicken Sie auf dem Blatt **Lizenzen | Übersicht** auf **Alle Produkte**, aktivieren Sie das Kontrollkästchen **Microsoft Entra ID P2**, und klicken Sie darauf, um es zu öffnen.

    >**Hinweis**: In Lab 4, Übung 2, Aufgabe 4 **Zuweisen von Microsoft Entra ID P2-Lizenzen zu Microsoft Entra-Benutzern** sollten Sie die Premium-Lizenzen an die Benutzer **aaduser1, aaduser2 und aaduser3** vergeben. Stellen Sie sicher, dass Sie diese Lizenzen von den zugewiesenen Benutzern entfernen.
